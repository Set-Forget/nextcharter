...
export default class MultiSelect extends Component {
    ...
    handleChange = (selectedOptions) => {
        this.props.setSelectedCompetenciesState(selectedOptions.map((opt) => opt.value));
    };
    ...
    render() {
        ...
        const selectedValues = options.filter((option) => selectedCompetencies.includes(option.value));
        ...
        const customStyles = {
            ...
            option: (provided, state) => ({
                ...provided,
                backgroundColor: state.isSelected ? "transparent text-black" : "white text-black",
