...
export default function TableView() {
  ...
  const filteredByName = (criteriaV !== '' && valuev !== '') ? students.data.filter(function(student) {
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-gray-100 place-items-center pt-20 relative">
      <Table people={filteredByName} value={valuev} setvalue={setvalue} criteria={criteriaV} setCriteria={setCriteria} />
    </main>
  )
}